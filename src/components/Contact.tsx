      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-12 text-center">
        ...
        <div className="reveal flex flex-col sm:flex-row items-center justify-center gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="#"
              className="w-12 h-12 rounded-full border border-border flex items-center justify-center text-text-secondary hover:border-gold hover:text-gold transition-all duration-300"
              aria-label="LinkedIn"
            >
